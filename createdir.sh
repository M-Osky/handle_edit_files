...
# I add this to all my scripts, because I'm tired of most programs used in genomics either failing to write results if output directory does not exist or the oposite, failing to overwrite if they do exist
